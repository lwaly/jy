...
NEB_BIN=${NEB_HOME}/release/bin
NEB_CONF=${NEB_HOME}/release/conf
NEB_LIB=${NEB_HOME}/thirdlib/lib
NEB_LOG=${NEB_HOME}/release/log
NEB_TEMP=${NEB_HOME}/release/temp
export LD_LIBRARY_PATH=${NEB_LIB}

LOG_FILE="${NEB_HOME}/release/log/${SCRIPT_NAME}.log"
