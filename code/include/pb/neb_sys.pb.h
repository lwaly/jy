...
#ifndef PROTOBUF_INCLUDED_neb_5fsys_2eproto
#define PROTOBUF_INCLUDED_neb_5fsys_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_neb_5fsys_2eproto 
...
namespace google {
namespace protobuf {
template<> ::neb::ConfigInfo* Arena::CreateMaybeMessage<::neb::ConfigInfo>(Arena*);
template<> ::neb::LogLevel* Arena::CreateMaybeMessage<::neb::LogLevel>(Arena*);
template<> ::neb::TargetWorker* Arena::CreateMaybeMessage<::neb::TargetWorker>(Arena*);
template<> ::neb::TraceLog* Arena::CreateMaybeMessage<::neb::TraceLog>(Arena*);
template<> ::neb::WorkerLoad* Arena::CreateMaybeMessage<::neb::WorkerLoad>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace neb {
...
class ConfigInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:neb.ConfigInfo) */ {
 ...
 private:
  ...
  friend struct ::protobuf_neb_5fsys_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
inline void ConfigInfo::set_file_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:neb.ConfigInfo.file_name)
}
#endif
...
inline void ConfigInfo::set_file_content(::std::string&& value) {
  ...
  file_content_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.ConfigInfo.file_content)
}
#endif
...
inline void TargetWorker::set_worker_identify(::std::string&& value) {
  ...
  worker_identify_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.TargetWorker.worker_identify)
}
#endif
...
inline void TargetWorker::set_node_type(::std::string&& value) {
  ...
  node_type_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.TargetWorker.node_type)
}
#endif
...
inline void TraceLog::set_log_time(::std::string&& value) {
  ...
  log_time_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.TraceLog.log_time)
}
#endif
...
inline void TraceLog::set_node_type(::std::string&& value) {
  ...
  node_type_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.TraceLog.node_type)
}
#endif
...
inline void TraceLog::set_node_identify(::std::string&& value) {
  ...
  node_identify_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.TraceLog.node_identify)
}
#endif
...
inline void TraceLog::set_log_level(::std::string&& value) {
  ...
  log_level_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.TraceLog.log_level)
}
#endif
...
inline void TraceLog::set_code_file_name(::std::string&& value) {
  ...
  code_file_name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.TraceLog.code_file_name)
}
#endif
...
inline void TraceLog::set_code_function(::std::string&& value) {
  ...
  code_function_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.TraceLog.code_function)
}
#endif
...
inline void TraceLog::set_log_content(::std::string&& value) {
  ...
  log_content_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:neb.TraceLog.log_content)
}
#endif
...
#endif  // PROTOBUF_INCLUDED_neb_5fsys_2eproto
