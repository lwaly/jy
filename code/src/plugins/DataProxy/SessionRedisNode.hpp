...
namespace DataProxy {
    ...
    const unsigned long FNV_64_INIT1 = 0x100000001b3;
    const unsigned long FNV_64_PRIME1 = 0xcbf29ce484222325;

    enum E_HASH_ALGORITHM1 {
        HASH_fnv1a_641           = 0,
        HASH_fnv1_641            = 1,
        HASH_murmur3_321         = 2,
    };
    ...
    */
    class SessionRedisNode: public neb::Session, public neb::DynamicCreator<SessionRedisNode, std::string, int, int, double> {
    public:
        /**
        ...
        */
        SessionRedisNode(const std::string& strSessionId, int iHashAlgorithm = neb::HASH_fnv1a_64,
            int iVirtualNodeNum = 200, double dSessionTimeout = 0.0);
